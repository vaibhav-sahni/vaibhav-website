    ...
    <div
      ...
      {image ? (
        <div className="relative h-14 w-14 shrink-0 sm:h-16 sm:w-16">
            <QuoteIcon className="absolute -left-2 -top-2 h-4 w-4 stroke-black text-white dark:text-neutral-100" />
      ...
      <div className="flex flex-col gap-y-4">
       <p className="prose prose-sm font-medium italic text-white dark:text-neutral-100 sm:prose-base">{text}</p>
       <p className="text-xs italic text-white dark:text-neutral-100 sm:text-sm md:text-base lg:text-lg">-- {name}</p>
      </div>
    </div>
  ),
);
